...
//    }
    ...
    @Transactional(rollbackFor = { EntityNotFoundExceptions.class, EntityAlreadyExistsException.class, EntityInvalidArgumentException.class} )
    public TeacherReadOnlyDTO updateTeacher(TeacherEditDTO dto)
        ...
        try {
            Teacher teacher = teacherRepository.findByUuid(dto.uuid())
                    .orElseThrow(() -> new EntityNotFoundExceptions("Teacher with uuid=" + dto.uuid() + " not found"));
    ...
    @Transactional(rollbackFor = EntityNotFoundExceptions.class)
    public TeacherReadOnlyDTO deleteTeachersByUUID(UUID uuid) throws EntityNotFoundExceptions {
        try {
            Teacher teacher = teacherRepository.findByUuidAndDeletedFalse(uuid)
                    .orElseThrow(() -> new EntityNotFoundExceptions("Teacher with uuid=" + uuid + " not found"));
...
//            teacherRepository.save(teacher);
    ...
    @Override
    public TeacherReadOnlyDTO deleteTeacherByUUID(UUID uuid) {
        return null;
    }
    ...
    public TeacherEditDTO getTeacherByUUID(UUID uuid) throws EntityNotFoundExceptions {
    ...
    @Override
    @PreAuthorize("hasAuthority ('EDIT_TEACHERS')")
    @Transactional(readOnly = true)
