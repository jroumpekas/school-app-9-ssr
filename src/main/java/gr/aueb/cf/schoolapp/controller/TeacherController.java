...
//        TeacherReadOnlyDTO teacherReadOnlyDTO = new TeacherReadOnlyDTO("acfd-1234", "Αθανάσιος", "Ανδρούτσος");
        ...
        } catch (EntityAlreadyExistsException | EntityInvalidArgumentException | EntityNotFoundExceptions e) {
...
//            TeacherEditDTO teacherEditDTO = teacherService.getTeacherByUUID(uuid);
        ...
        } catch (EntityNotFoundException | EntityNotFoundExceptions e) {
            model.addAttribute("errorMessage", e.getMessage());
        }
        return "teacher-edit";
    }
    ...
    public String updateTeacher(@Valid @ModelAttribute("teacherEditDTO") TeacherEditDTO teacherEditDTO,
        ...
        } catch (EntityNotFoundException | EntityAlreadyExistsException | EntityInvalidArgumentException |
